...
FUNCTION(BUILD_PLUGIN PLUGIN_NAME)
	CMAKE_PARSE_ARGUMENTS(PLUGIN "" "DESTINATION;LINK" "MOCFILES;EMBEDDED_RESOURCES;UICFILES" ${ARGN})
	...
	INSTALL(TARGETS ${PLUGIN_NAME} LIBRARY DESTINATION "${PLUGIN_DESTINATION}")
